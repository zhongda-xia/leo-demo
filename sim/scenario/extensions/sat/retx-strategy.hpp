...
#ifndef NFD_DAEMON_FW_RETX_STRATEGY_HPP
#define NFD_DAEMON_FW_RETX_STRATEGY_HPP
 ...
 */
class RetxStrategy : public Strategy
{
public:
  explicit
  RetxStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
#endif // NFD_DAEMON_FW_RETX_STRATEGY_HPP

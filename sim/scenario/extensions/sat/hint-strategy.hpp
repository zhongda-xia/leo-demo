...
#ifndef NFD_DAEMON_FW_HINT_STRATEGY_HPP
#define NFD_DAEMON_FW_HINT_STRATEGY_HPP
 ...
 */
class HintStrategy : public Strategy
{
public:
  explicit
  HintStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
#endif // NFD_DAEMON_FW_HINT_STRATEGY_HPP
